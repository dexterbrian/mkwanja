...
<div id="main-container">
    <div id="ui">
        <ProfileContainer />
        <div id="month" class="font-bold">Dec 2023</div>
        ...
        <div class="card bg-primary text-primary-content">
            <div class="card-body">
                ...
                <h1 class="text-white font-bold text-3xl">KES 44,840</h1>
            </div>
        </div>

        <!-- My Budget Section -->
        <div id="my-budget" class="mt-6 text-black">
            <div class="section-title">My Budget<span class="text-black text-xs ml-6">KES 200 left to budget</span></div>
