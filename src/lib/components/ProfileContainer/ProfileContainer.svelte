...
<div id="profile-container">
    <div class="flex flex-row justify-between">
        <div class="flex flex-row">
            <img id="profile-pic" alt="default-profile" src={defaultProfileImage}>
            <div id="profile-info">
                <h4 id="name" class="text-sm">Dexter</h4>
                <p id="amount-saved" class="text-xs font-normal">Saved <strong class="font-bold">KES 189K / KES 1M</strong></p>
            </div>
        </div>
        <div id="edit-profile-container">
            <div id="edit-profile-button" class="ml-8">
